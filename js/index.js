document.addEventListener("DOMContentLoaded", () => {
    ...
    function changeHeadingAnimation(){
        if(hFront.classList.contains('hf-effect') && hBack.classList.contains('hb-effect')){
    ...
    function floatingOnScroll(content, speed){
        if(window.scrollY+window.innerHeight > content.offsetTop  && window.scrollY < content.offsetTop+content.offsetHeight){
